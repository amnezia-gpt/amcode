...
afterEach(async () => {
  ...
  if (originalCodexHome === undefined) {
    delete process.env.AMCODE_HOME;
  } else {
    process.env.AMCODE_HOME = originalCodexHome;
  }
