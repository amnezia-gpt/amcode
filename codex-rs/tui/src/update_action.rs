...
pub enum UpdateAction {
    /// Update via `npm install -g @amnezia-gpt/amcode@latest`.
    NpmGlobalLatest,
    /// Update via `bun install -g @amnezia-gpt/amcode@latest`.
    BunGlobalLatest,
...
impl UpdateAction {
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            UpdateAction::NpmGlobalLatest => ("npm", &["install", "-g", "@amnezia-gpt/amcode"]),
            UpdateAction::BunGlobalLatest => ("bun", &["install", "-g", "@amnezia-gpt/amcode"]),
