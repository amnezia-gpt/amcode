...
/// Expected structure for $AMCODE_HOME/auth.json.
...
impl FileAuthStorage {
    ...
    /// Attempt to read and parse the `auth.json` file in the given `AMCODE_HOME` directory.
...
const KEYRING_SERVICE: &str = "Amcode Auth";
