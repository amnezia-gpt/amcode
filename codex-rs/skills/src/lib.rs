...
/// Returns the on-disk cache location for embedded system skills from an absolute AMCODE_HOME.
...
/// Installs embedded system skills into `AMCODE_HOME/skills/.system`.
///
